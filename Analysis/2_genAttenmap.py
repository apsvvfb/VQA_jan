...
def draw(imgpath,atten,outpath):
  ...
  outfile="%s/%s.png" % (outpath,os.path.basename(imgpath).split('.')[0])
  print outfile
...
if __name__ == "__main__":
  ...
  #without attenmpas
  file_pred1="/home/c-nrong/VQA/Jan_HieCoAttenVQA2/data/eval_prediction.h5"  
  #with attenmaps
  file_pred2="/home/c-nrong/VQA/Jan_HieCoAttenVQA4/data/eval_prediction.h5"  
  jfile = json.load(open(file_json, 'r'))
  unique_img=jfile["uniuqe_img_test"] 
  #print(unique_img[0])

  with h5py.File(file_atten,'r') as hf:
        data1 = hf.get('areaprobs')
  ...
  for i in range(len(pred1)):
	...
	imgpath="/home/c-nrong/VQA/"+imgname
	outpath="draw/"
